                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('subscriptions.update',$sub->id) }}" method="POST"
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="subscription_number" class="form-control"
                                                    placeholder="subscription number" value="{{$sub->sub_number}}" required name="sub_number" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea type="text"  id="subscription_address" class="form-control" placeholder="Subscription Address " required
                                                    name="sub_address">{{$sub->sub_address}}</textarea>
                                            </div>
                                        </div>
                                        {{-- <div class="col-md-6 col-12">
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="counter_id" id="counter_id" required
                                                    ...
                                                    @foreach ($counter as $item)
                                                        <option value="{{ $item->id }}"
                                                            {{ old('id') == $item->id ? 'selected' : ($item->id) }}>
